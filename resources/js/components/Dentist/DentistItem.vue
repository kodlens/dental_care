    ...
    methods: {
        ...
        */
        loadAsyncData() {
            ...
            this.loading = true
            axios.get(`/dentist/get-dentist-items?${params}`)
                .then(({ data }) => {
                    this.data = [];
        ...
        */
        ...
        deleteSubmit(delete_id) {
            axios.delete('/dentist/dentist-items/' + delete_id).then(res => {
                this.loadAsyncData();
            }).catch(err => {
        ...
        getData: function(data_id){
            ...
            axios.get('/dentist/dentist-items/' + data_id).then(res=>{
        ...
        submit: function(){
            if(this.global_id > 0){
                //update
                axios.put('/dentist/dentist-items/'+this.global_id, this.fields).then(res=>{
                ...
                //INSERT HERE
                axios.post('/dentist/dentist-items', this.fields).then(res=>{
